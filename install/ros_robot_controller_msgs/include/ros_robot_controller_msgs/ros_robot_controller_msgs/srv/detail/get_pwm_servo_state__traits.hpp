...
inline void to_flow_style_yaml(
  const GetPWMServoState_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const GetPWMServoState_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use ros_robot_controller_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const ros_robot_controller_msgs::srv::GetPWMServoState_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  ros_robot_controller_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use ros_robot_controller_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const ros_robot_controller_msgs::srv::GetPWMServoState_Event & msg)
{
  return ros_robot_controller_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<ros_robot_controller_msgs::srv::GetPWMServoState_Event>()
{
  return "ros_robot_controller_msgs::srv::GetPWMServoState_Event";
}

template<>
inline const char * name<ros_robot_controller_msgs::srv::GetPWMServoState_Event>()
{
  return "ros_robot_controller_msgs/srv/GetPWMServoState_Event";
}

template<>
struct has_fixed_size<ros_robot_controller_msgs::srv::GetPWMServoState_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<ros_robot_controller_msgs::srv::GetPWMServoState_Event>
  : std::integral_constant<bool, has_bounded_size<ros_robot_controller_msgs::srv::GetPWMServoState_Request>::value && has_bounded_size<ros_robot_controller_msgs::srv::GetPWMServoState_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<ros_robot_controller_msgs::srv::GetPWMServoState_Event>
  : std::true_type {};
